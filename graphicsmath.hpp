...
/* PLAINLY MARKED AS ALTERED */

#ifndef  _GRAPHICS_MATH_HPP
#define  _GRAPHICS_MATH_HPP 1
...
RMDEF Vector3 MatrixMultiply(Matrix_3x3 left, Vector3 right)
{
    Vector3 result = { 0 };
    result.x = left.m0*right.x + left.m3*right.y + left.m6*right.z;
